...
namespace fips
{
    ...
    void save_per_test_results(std::ofstream &out, const fips::test_params &params, const std::array<test_status, N_FIPS_TESTS> &statuses)
    {
    ...
    void save_to_json(std::ofstream &out, const fips::test_params &params, bool battery_success, const std::array<test_status, N_FIPS_TESTS> &statuses)
    {
        out << "{" << std::endl;
        out << "\t\"status\": ";
        if (battery_success)
    ...
    void save_to_txt(std::ofstream &out, const fips::test_params &params, bool battery_success, const std::array<test_status, N_FIPS_TESTS> &statuses)
    {
