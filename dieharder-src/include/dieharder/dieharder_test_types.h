...
static Dtest *dh_test_types[MAXTESTS];
...
#define ADD_TEST(t) {if (i==MAXTESTS) abort(); dh_test_types[i] = (t); i++; };
  ...
  * defined above.
  */
static unsigned int dh_num_diehard_tests;  /* diehard tests available in dieharder */
static unsigned int dh_num_sts_tests;      /* STS tests available in dieharder */
static unsigned int dh_num_other_tests;    /* other tests available in dieharder */
static unsigned int dh_num_user_tests;     /* user tests added in ui segment */
static unsigned int dh_num_tests;          /* total tests available in dieharder */


static Dtest *dh_test;             /* global pointer to the current test */
